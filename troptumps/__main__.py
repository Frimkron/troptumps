...
TODO: Fix first sentence for "v.", "Co.", "Corp."
    TODO: reorganise in order to have actual unit tests
...
def main():    
    ...
    ap.add_argument('-m','--pagemargin',type=float,default=DEFAULT_PAGE_MARGIN_MM,
                    help="Page margin in mm. Defaults to {}.".format(DEFAULT_PAGE_MARGIN_MM))
    ap.add_argument('-b','--bleedmargin',type=float,default=DEFAULT_BLEED_MARGIN_MM,
                    help="Bleed area to leave around cards, in mm. Defaults to {}.".format(DEFAULT_BLEED_MARGIN_MM))
